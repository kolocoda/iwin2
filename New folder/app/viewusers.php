...
?>
	...
	<div class="greetblock">
		<div class="leftdiv">
			<p class="header">Select Users to whom you want to send Announcement
			</p>
			<table>
				...
				<tr>
					...
					<td><span class="wrapper"><input type="checkbox" name="sendmsg[]" value="<?php echo $row["user_id"] ?>"/></span></td>
				</tr>
				<?php } ?>
			</table>
		</div>
		...
		<div class="rightdiv">
			<p class="header">Send your announcement to your Users
			</p>
			<center>
